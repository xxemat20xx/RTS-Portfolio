...
import '../index.css';
import useScrollAnimation from '../customhook/useScrollAnimation';
  ...
  return (
    <section className="hero-section mx-auto flex justify-center items-center min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div ref={elementRef}>
          <div
            className="hero-content order-2 md:order-1 flex flex-col items-start justify-center p-4 transition-all duration-700 ease-out"
            style={{
            ...
            <div className="tech-stack flex flex-wrap gap-4">
              {techStackImages.map((image) => (
                <div key={image.id} className="tech-stack-image">
                  <img src={image.techStackImage} alt="" className="w-10 h-10 transition-all duration-700 ease-out" 
                  style={{
